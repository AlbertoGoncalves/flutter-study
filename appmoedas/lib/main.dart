...
const request = 'https://api.hgbrasil.com/finance/quotations?key=4ddedef1';
      ...
      body: FutureBuilder<Map>(
          ...
          builder: (context, snapshot) {
            switch (snapshot.connectionState) {
              case ConnectionState.none: //Não conectado
              case ConnectionState.waiting: //Aguardando dados
                return const Center(
                  child: Text(
                    "Carregando dados...",
